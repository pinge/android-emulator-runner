...
exports.checkDiskSize = exports.checkEmulatorBuild = exports.checkAdbPath = exports.checkLocale = exports.checkApk = exports.checkWaitForNetwork = exports.checkCleanupAvd = exports.checkDisableStylusHandwriting = exports.checkDisableImmersiveModeConfirmation = exports.checkEnableHardwareKeyboard = exports.checkDisableLinuxHardwareAcceleration = exports.checkDisableSpellchecker = exports.checkDisableAnimations = exports.checkPort = exports.checkForceAvdCreation = exports.checkChannel = exports.checkArch = exports.checkTarget = exports.checkApiLevel = exports.PREVIEW_API_LEVELS = exports.MAX_PORT = exports.MIN_PORT = exports.VALID_CHANNELS = exports.VALID_ARCHS = exports.VALID_TARGETS = exports.MIN_API_LEVEL = void 0;
...
function checkDisableImmersiveModeConfirmation(disableImmersiveModeConfirmation) {
...
exports.checkDisableImmersiveModeConfirmation = checkDisableImmersiveModeConfirmation;
function checkDisableStylusHandwriting(disableStylusHandwriting) {
...
exports.checkDisableStylusHandwriting = checkDisableStylusHandwriting;
...
function checkWaitForNetwork(waitForNetwork) {
    if (!isValidBoolean(waitForNetwork)) {
        throw new Error(`Input for input.wait-for-network should be either 'true' or 'false'.`);
    }
}
exports.checkWaitForNetwork = checkWaitForNetwork;
function checkApk(apk) {
...
exports.checkAdbPath = checkAdbPath;
