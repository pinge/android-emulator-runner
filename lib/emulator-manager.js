...
function launchEmulator(apiLevel, target, arch, profile, cores, ramSize, heapSize, sdcardPathOrSize, diskSize, avdName, forceAvdCreation, emulatorBootTimeout, port, emulatorOptions, disableAnimations, disableSpellChecker, disableLinuxHardwareAcceleration, enableHardwareKeyboard, disableImmersiveModeConfirmation, disableStylusHandwriting, apk, locale) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (locale.length > 0) {
                yield waitForLocale(port, emulatorBootTimeout, locale);
            }
            yield waitForNetwork(parseInt(apiLevel, 10), port, emulatorBootTimeout);
 ...
 */
function waitForNetwork(apiLevel, port, emulatorBootTimeout) {
    return __awaiter(this, void 0, void 0, function* () {
